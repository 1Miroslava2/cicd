...
@SpringBootTest
@ActiveProfiles("test")
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.ANY) // remplacer la base par la base test
public class CustomerServiceIntegrationTest {
    ...
    @Test
    void getCustomer(){
        // on appelle le service pour recuperer un client avec l'identifiant "054b145c-ddbc-4136-a2bd-7bf45ed1bef7
        Customer customer = this.customerService.getCustomer("054b145c-ddbc-4136-a2bd-7bf45ed1bef7");

        // On verifie que le client retourné n'est pas null
        assertNotNull(customer);

        // On verifie que le prenom client  est bien "Cally"
...
// 9: On appelle le service pour récupérer un client avec un id qui n'existe pas
        assertThrows(NotFoundException.class, () -> this.customerService.getCustomer("d972b30f-21cc-411f-b374-685ce23cd317"), "should have thrown an exception");
    }

    @Test
    void addCustomer(){
// 10: On crée un nouveau client ( ca enregistre dans la base de donnés en memoire mais pas sur data.sql)
